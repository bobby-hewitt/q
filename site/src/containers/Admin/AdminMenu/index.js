	...
	render(){
		return(
			<div className="adminMenuContainer">
				...
				<AdminMenuButton copy="Memebers" isActive={this.props.menuItem === 'members'} buttonId="members" action={this.menuItemSelected.bind(this)}/>
				...
				<AdminMenuButton copy="Settings" isActive={this.props.menuItem === 'settings'} buttonId="settings" action={this.menuItemSelected.bind(this)}/>
			</div>
		)
	}
}
